  ...
  const scrollSectionHintModule = {
    ...
    getSectionContext() {
      ...
      for (let i = 0; i < sections.length; i += 1) {
        ...
        // Sonderbehandlung für die erste echte Section
        if (section.id === "about") {
    ...
    buildHomeAboutSpecialPlacements(context, geometry) {
      ...
      // Nur aktiv, solange die Grenze Home/About überhaupt sichtbar ist
      if (
      ...
      if (scrollingUp) {
        // Von #about zurück Richtung Home
      ...
      // Von Home nach unten Richtung #about
      if (boundaryY >= middleThirdEnd) {
        return [];
      }
